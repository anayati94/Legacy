...
public class TrajectoryHandler {
	...
	public static boolean isDoorBlocking(int x, int y) {
		GameObject blocker = RegionManager.getRegion(Point.location(x, y)).getWallGameObject(Point.location(x, y));
		if(blocker != null) {
			if(blocker.getDoorDef().blocksRanged) {
				return true;
			}
		}
		return false;
	...
	public static boolean isObjectBlocking(int x, int y) {
		GameObject blocker = RegionManager.getRegion(Point.location(x, y)).getGameObject(Point.location(x, y));
		if(blocker != null) {
