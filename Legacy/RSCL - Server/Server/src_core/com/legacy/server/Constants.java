...
public final class Constants {
	...
	public static final class GameServer {
		 ...
		 */
		public static final AttributeKey<ConnectionAttachment> SESSION_KEY = AttributeKey.valueOf("session.key");
		/** 
		 * RSC GAME TICK.
		 */	    	
		 ...
		 * the servers name
		 */
		public static String SERVER_NAME = "RSCLegacy";
		/**
		 ...
		 */
		public static String SERVER_LOCATION = "Canada";
		/**
		 *  mysql prefix
		 */
		public static String MYSQL_TABLE_PREFIX = "rscl_";
		/**
		...
		/**
		 * Avatar path directory : /usr/share/nginx/html/rsclegacy/img/playercard/
		 */
		...
		public static boolean DEVELOPMENT_PLATFORM = false;
		/**
		 * 
		 * @param file
		 * @throws IOException
		...
		public static void initConfig(String file) throws IOException {
			...
			DEVELOPMENT_PLATFORM = Boolean.parseBoolean(props.getProperty("development_platform"));
